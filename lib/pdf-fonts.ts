export const PDF_FONTS = [
  ...
  { value: "sans", label: "Liberation Sans", family: "Forma Sans", file: "LiberationSans-Regular.ttf" },
...
export function fontFile(id?: string, bold = false, italic = false) {
  ...
  const suffix = font.value === "roboto" ? (bold ? "Medium" : "") + (italic ? "Italic" : "") : (bold ? "Bold" : "") + (italic ? "Italic" : "");
